...
#ifdef CATCH_CONFIG_WINDOWS_CRTDBGLN
#include <crtDBGLN.h>
class LeakDetector {
public:
    LeakDetector() {
        int flag = _CrtSetDBGLNFlag(_CRTDBGLN_REPORT_FLAG);
        flag |= _CRTDBGLN_LEAK_CHECK_DF;
        flag |= _CRTDBGLN_ALLOC_MEM_DF;
        _CrtSetDBGLNFlag(flag);
        _CrtSetReportMode(_CRT_WARN, _CRTDBGLN_MODE_FILE | _CRTDBGLN_MODE_DEBUG);
        _CrtSetReportFile(_CRT_WARN, _CRTDBGLN_FILE_STDERR);
